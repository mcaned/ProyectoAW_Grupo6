<header style="background-color: #333; color: white; padding: 40px; position: relative; text-align: center;">
    <div style="position: absolute; left: 40px; top: 50%; transform: translateY(-50%);">
        <img src="<?= RUTA_APP ?>/img/logo.png" style="width: 280px;">
    </div>
    <h1>BISTRO FDI</h1>
    ...
    <div style="position: absolute; bottom: 10px; right: 20px;">
        <?php if (isset($_SESSION['login'])): ?>
            ...
            <a href="<?= RUTA_APP ?>/logout.php" style="color:white;">Salir</a>
        <?php else: ?>
            <a href="<?= RUTA_APP ?>/login.php" style="color:white;">Login</a> | 
            <a href="<?= RUTA_APP ?>/registro.php" style="color:white;">Registro</a>
        <?php endif; ?>
    </div>
</header>
