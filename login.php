...
<div style="display: flex; min-height: 80vh;">
    <?php include __DIR__ . '/includes/vistas/comun/sidebarIzq.php'; ?> <main style="flex-grow: 1; padding: 40px; background: white;">
        <h1>Acceso al sistema</h1>
        <?= $htmlFormulario ?>
    </main>

    <?php include __DIR__ . '/includes/vistas/comun/sidebarDer.php'; ?> </div>
